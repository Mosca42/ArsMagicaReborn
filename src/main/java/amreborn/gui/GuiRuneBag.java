...
import amreborn.container.InventoryRuneBag;
...
public class GuiRuneBag extends GuiContainer{
	...
	private static final ResourceLocation background = new ResourceLocation(ArsMagicaReborn.MODID, "textures/gui/rune_bag_gui.png");
