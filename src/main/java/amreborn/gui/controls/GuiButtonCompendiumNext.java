...
public class GuiButtonCompendiumNext extends GuiButton{
	...
	private static final ResourceLocation buttonImage = new ResourceLocation(ArsMagicaReborn.MODID, "textures/gui/ArcaneCompendiumGuiExtras.png");
