...
import amreborn.spell.SpellValidator.ValidationResult;
...
public class GuiInscriptionTable extends GuiContainer{
	...
	private static final ResourceLocation background = new ResourceLocation(ArsMagicaReborn.MODID, "textures/gui/inscriptiontablegui.png");
