...
public class GuiEssenceRefiner extends GuiContainer{
	...
	private static final ResourceLocation background = new ResourceLocation(ArsMagicaReborn.MODID, "textures/gui/essenceextractorgui.png");
	private static final ResourceLocation extras = new ResourceLocation(ArsMagicaReborn.MODID, "textures/gui/essenceextractorgui_2.png");
