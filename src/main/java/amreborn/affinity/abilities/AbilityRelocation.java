...
public class AbilityRelocation extends AbstractAffinityAbility {
	...
	public AbilityRelocation() {
		super(new ResourceLocation(ArsMagicaReborn.MODID, "relocation"));
	}
	...
	public void applyKeyPress(EntityPlayer player) {
		...
		AffinityData.For(player).addCooldown("EnderTP", ArsMagicaReborn.config.getEnderAffinityAbilityCooldown());
	}
