...
public class AbilityFulmination extends AbstractAffinityAbility {
	...
	public AbilityFulmination() {
		super(new ResourceLocation(ArsMagicaReborn.MODID, "fulmination"));
	}
		...
		if (!ent.world.isRemote){
			...
			if (lightningDepth >= 0.7f && ent.getRNG().nextDouble() < 0.05f){
				...
				for (EntityCreeper creeper : creepers){
					...
					ArsMagicaReborn.proxy.particleManager.BoltFromEntityToEntity(ent.world, ent, ent, creeper, 0, 1, -1);
				}
			}
		}
	}
