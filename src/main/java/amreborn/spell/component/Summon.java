...
public class Summon extends SpellComponent {
	...
	public Class<? extends Entity> getSummonType(ItemStack stack) {
		...
		Class<? extends Entity> clazz = (Class<? extends Entity>) ForgeRegistries.ENTITIES.getValue(new ResourceLocation(s)).getEntityClass();
		return clazz;
	}
	...
	public void setSummonType(NBTTagCompound stack, Class<? extends Entity> clazz) {
		...
		String s = (String) ForgeRegistries.ENTITIES.getValue(new ResourceLocation(clazz.getName())).toString();
		if (s == null)
			s = "";
