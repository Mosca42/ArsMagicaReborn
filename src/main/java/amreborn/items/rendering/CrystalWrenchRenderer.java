package amreborn.items.rendering;
...
public class CrystalWrenchRenderer implements ItemMeshDefinition {
	...
	private ModelResourceLocation loc_default = new ModelResourceLocation(ArsMagicaReborn.MODID + ":crystal_wrench", "inventory");
	private ModelResourceLocation loc_disconnect = new ModelResourceLocation(ArsMagicaReborn.MODID + ":crystal_wrench_disconnect", "inventory");
	private ModelResourceLocation loc_stored = new ModelResourceLocation(ArsMagicaReborn.MODID + ":crystal_wrench_stored", "inventory");
