...
public class ItemArcaneGuardianSpellbook extends ItemSpellBook {
	...
	public String getItemStackDisplayName(ItemStack par1ItemStack) {
		...
		if (activeSpell != null) {
			return String.format("\2477%s \2477(" + activeSpell.getDisplayName() + "\2477)", I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":arcaneSpellBook.name"));
		}
		return I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":arcane_spellbook.name");
	}
}
