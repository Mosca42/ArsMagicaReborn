...
import amreborn.container.InventorySpellBook;
...
//	private final String[] player_textureFiles = {"spell_book_cover", "spell_book_decoration"};
	...
	public String getItemStackDisplayName(ItemStack par1ItemStack){
		...
		if (activeSpell != null){
			return String.format("\2477%s (" + activeSpell.getDisplayName() + "\2477)", I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":spellbook.name"));
		}
		return I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":spellbook.name");
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand hand) {
		if (playerIn.isSneaking()){
			FMLNetworkHandler.openGui(playerIn, ArsMagicaReborn.instance, IDDefs.GUI_SPELL_BOOK, worldIn, (int)playerIn.posX, (int)playerIn.posY, (int)playerIn.posZ);
	...
	public void onPlayerStoppedUsing(ItemStack stack, World worldIn, EntityLivingBase entityLiving, int timeLeft) {
		if (entityLiving.isSneaking()){
			FMLNetworkHandler.openGui((EntityPlayer) entityLiving, ArsMagicaReborn.instance, IDDefs.GUI_SPELL_BOOK, worldIn, (int)entityLiving.posX, (int)entityLiving.posY, (int)entityLiving.posZ);
		}else{
