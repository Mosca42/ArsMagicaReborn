...
public class ItemCore extends ItemArsMagica {
	...
	public String getItemStackDisplayName(ItemStack stack) {
		String name = I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":core." + (stack.getItemDamage() == META_BASE_CORE ? "base" : (stack.getItemDamage() == META_HIGH_CORE ? "high" : "pure")) + ".name");
		return name;
	}
