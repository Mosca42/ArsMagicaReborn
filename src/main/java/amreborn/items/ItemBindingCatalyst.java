...
public class ItemBindingCatalyst extends ItemArsMagica {
	...
	public String getItemStackDisplayName(ItemStack stack) {
		...
		String baseName = I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":bindingCatalyst.name");

		switch (meta) {
		case META_PICK:
			return baseName + I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":bindingCatalystPick.name");
		case META_AXE:
			return baseName + I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":bindingCatalystAxe.name");
		case META_SWORD:
			return baseName + I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":bindingCatalystSword.name");
		case META_SHOVEL:
			return baseName + I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":bindingCatalystShovel.name");
		case META_HOE:
			return baseName + I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":bindingCatalystHoe.name");
		case META_BOW:
			return baseName + I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":bindingCatalystBow.name");
		case META_SHIELD:
			return baseName + I18n.translateToLocal("item." + ArsMagicaReborn.MODID + ":bindingCatalystShield.name");
		}
		return baseName;
	}
