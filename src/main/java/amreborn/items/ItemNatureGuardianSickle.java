...
public class ItemNatureGuardianSickle extends ItemArsMagica{
	...
	public ActionResult<ItemStack> onItemRightClick(World par2World, EntityPlayer par3EntityPlayer, EnumHand hand){
		if (flingSickle(par3EntityPlayer.getHeldItem(hand), par2World, par3EntityPlayer)){
		...
		return new ActionResult<>(EnumActionResult.SUCCESS, par3EntityPlayer.getHeldItem(hand));
	}
