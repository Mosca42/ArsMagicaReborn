...
public class ItemManaPotionBundle extends ItemArsMagica {
	...
	public String getItemStackDisplayName(ItemStack par1ItemStack) {
		Item potion = getPotion(par1ItemStack.getItemDamage());
		if (potion == ItemDefs.lesserManaPotion) {
			return String.format("%s %s", I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":lesser_mana_potion.name"), I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":potion_bundle.name"));
		} else if (potion == ItemDefs.standardManaPotion) {
			return String.format("%s %s", I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":standard_mana_potion.name"), I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":potion_bundle.name"));
		} else if (potion == ItemDefs.greaterManaPotion) {
			return String.format("%s %s", I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":greater_mana_potion.name"), I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":potion_bundle.name"));
		} else if (potion == ItemDefs.epicManaPotion) {
			return String.format("%s %s", I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":epic_mana_potion.name"), I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":potion_bundle.name"));
		} else if (potion == ItemDefs.legendaryManaPotion) {
			return String.format("%s %s", I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":legendary_mana_potion.name"), I18n.translateToLocal("item."+ ArsMagicaReborn.MODID +":potion_bundle.name"));
		}
