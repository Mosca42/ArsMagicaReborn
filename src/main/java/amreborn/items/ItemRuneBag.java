...
public class ItemRuneBag extends ItemArsMagica{
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entityplayer, EnumHand hand){
		if (entityplayer.isSneaking()){
			FMLNetworkHandler.openGui(entityplayer, ArsMagicaReborn.instance, IDDefs.GUI_RUNE_BAG, world, (int)entityplayer.posX, (int)entityplayer.posY, (int)entityplayer.posZ);
		}
