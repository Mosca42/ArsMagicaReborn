package amreborn.api.compendium;
...
public final class CompendiumCategory {
	...
	public static final CompendiumCategory GUIDE = createCompendiumCategory("guide", new ResourceLocation(ArsMagicaReborn.MODID, "items/arcanecompendium"));
	public static final CompendiumCategory MECHANIC = createCompendiumCategory("mechanic", new ResourceLocation(ArsMagicaReborn.MODID, "items/magitech_goggle"));
	...
	public static final CompendiumCategory ITEM = createCompendiumCategory("item", new ResourceLocation(ArsMagicaReborn.MODID, "items/essence_ice"));
	...
	public static final CompendiumCategory BLOCK = createCompendiumCategory("block", new ResourceLocation(ArsMagicaReborn.MODID, "items/crystal_wrench"));
	...
	public static final CompendiumCategory SPELL_SHAPE = createCompendiumCategory("shape", new ResourceLocation(ArsMagicaReborn.MODID, "items/spells/shapes/binding"));
	public static final CompendiumCategory SPELL_COMPONENT = createCompendiumCategory("component", new ResourceLocation(ArsMagicaReborn.MODID, "items/spells/components/lifeTap"));
	public static final CompendiumCategory SPELL_MODIFIER = createCompendiumCategory("modifier", new ResourceLocation(ArsMagicaReborn.MODID, "items/spells/modifiers/velocityadded"));
	public static final CompendiumCategory TALENT = createCompendiumCategory("talent", new ResourceLocation(ArsMagicaReborn.MODID, "items/spells/skills/augmentedcasting"));
	public static final CompendiumCategory MOB = createCompendiumCategory("mob", new ResourceLocation(ArsMagicaReborn.MODID, "gui_icons/fatigue_icon"));
	public static final CompendiumCategory MOB_FLICKER = createCompendiumCategory("mob.flicker", new ResourceLocation("missingno"));
	public static final CompendiumCategory STRUCTURE = createCompendiumCategory("structure", new ResourceLocation(ArsMagicaReborn.MODID, "gui_icons/gateway"));
	public static final CompendiumCategory BOSS = createCompendiumCategory("boss", new ResourceLocation(ArsMagicaReborn.MODID, "items/evilbook"));
