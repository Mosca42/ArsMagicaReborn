...
public class Affinity extends IForgeRegistryEntry.Impl<Affinity> implements Comparable<Affinity>{
	...
	private static final ResourceLocation NONE_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "none");
	private static final ResourceLocation ARCANE_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "arcane");
	private static final ResourceLocation WATER_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "water");
	private static final ResourceLocation FIRE_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "fire");
	private static final ResourceLocation EARTH_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "earth");
	private static final ResourceLocation AIR_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "air");
	private static final ResourceLocation LIGHTNING_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "lightning");
	private static final ResourceLocation ICE_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "ice");
	private static final ResourceLocation NATURE_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "nature");
	private static final ResourceLocation LIFE_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "life");
	private static final ResourceLocation ENDER_LOC = new ResourceLocation(ArsMagicaReborn.MODID, "ender");
