...
public class ArsMagicaModelLoader implements ICustomModelLoader {
	...
	public void preStitch(TextureStitchEvent.Pre e) {
		for (Affinity aff : ArsMagicaAPI.getAffinityRegistry().getValues()) {
			e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID, "items/particles/" + aff.getName().toLowerCase() + "_hand"));
			sprites.put(aff, e.getMap().getTextureExtry(new ResourceLocation(ArsMagicaReborn.MODID, "items/particles/" + aff.getName().toLowerCase() + "_hand").toString()));
		}
		...
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/custom/obelisk"));
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/custom/obelisk_active"));
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/custom/obelisk_active_highpower"));
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/custom/obelisk_runes"));
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/custom/celestial_prism"));
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/custom/crystalmarker"));
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/custom/habitat"));
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/custom/essencecrystal"));
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/custom/arcane_reconstructor"));
		e.getMap().registerSprite(new ResourceLocation(ArsMagicaReborn.MODID + ":blocks/everstone"));
		for (Affinity aff : ArsMagicaAPI.getAffinityRegistry().getValues()) {
