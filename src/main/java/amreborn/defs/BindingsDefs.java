...
import amreborn.gui.AuraCustomizationMenu;
...
//					boolean curDisplayFlag = ArsMagicaReborn.config.displayManaInInventory();
//					ArsMagicaReborn.config.setDisplayManaInInventory(!curDisplayFlag);
//				}
//			}
//			return;
//		}
...
//		}
			...
			if (ArsMagicaReborn.proxy.playerTracker.hasAA(clientPlayer)){
