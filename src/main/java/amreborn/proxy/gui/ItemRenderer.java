...
public class ItemRenderer {
	private static final ResourceLocation sickleLocation = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/bosses/plant_guardian.png");
	private static final ResourceLocation arcaneBookLocation = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/bosses/arcane_guardian.png");
	private static final ResourceLocation winterArmLocation = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/bosses/ice_guardian.png");
	private static final ResourceLocation airLocation = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/bosses/air_guardian.png");
	private static final ResourceLocation waterLocation = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/bosses/water_guardian.png");
	private static final ResourceLocation fireLocation = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/bosses/fire_guardian.png");
	private static final ResourceLocation earthLocation = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/bosses/earth_guardian.png");
	private static final ResourceLocation broomLocation = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/broom.png");
	private static final ResourceLocation candleLocation = new ResourceLocation(ArsMagicaReborn.MODID, "textures/blocks/custom/candle.png");
	...
	public void renderItemEvent(RenderingItemEvent event) {
		if (event.getStack().getItem() == Item.getItemFromBlock(BlockDefs.obelisk)) {
 
			if (event.getCameraTransformType() == TransformType.THIRD_PERSON_LEFT_HAND || (event.getCameraTransformType() == TransformType.THIRD_PERSON_RIGHT_HAND || event.getCameraTransformType() == TransformType.FIRST_PERSON_LEFT_HAND || event.getCameraTransformType() == TransformType.FIRST_PERSON_RIGHT_HAND))
				GlStateManager.scale(0.3, 0.3, 0.3);
			
			
			if (event.getCameraTransformType() == TransformType.GUI) {
				GlStateManager.scale(0.2, 0.2, 0.2);
				GlStateManager.translate(-0.5, -1.7, 0);
			}
			if (event.getCameraTransformType() == TransformType.GROUND) {
		...
		if (event.getStack().getItem() == ItemDefs.BoundShield) {
			Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(ArsMagicaReborn.MODID + ":textures/models/bound_shield.png"));
		...
		if (event.getStack() == null || event.getStack().getItem() == null || Block.getBlockFromItem(event.getStack().getItem()) == null)
			return;
	...
	private void renderCandleFlame(TransformType type, ItemStack item, Object... data) {
		...
		if (item.hasTagCompound()) {
			GlStateManager.color(item.getTagCompound().getFloat("flame_red"), item.getTagCompound().getFloat("flame_green"), item.getTagCompound().getFloat("flame_blue"));
		}
		GlStateManager.pushMatrix();
