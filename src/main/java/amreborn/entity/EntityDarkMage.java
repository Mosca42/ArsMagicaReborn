...
import amreborn.entity.ai.selectors.DarkMageEntitySelector;
...
//	}
	...
	public String getTexture(){
		return String.format(ArsMagicaReborn.MODID + ":textures/mobs/dark_mages/dark_mage_%d.png", this.dataManager.get(MAGE_SKIN).intValue());
	}
