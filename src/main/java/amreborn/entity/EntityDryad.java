...
public class EntityDryad extends EntityCreature{
	...
	public void onUpdate(){
		...
		if (world.rand.nextInt(100) == 3){
			AMParticle effect = (AMParticle)ArsMagicaReborn.proxy.particleManager.spawn(world, "hr_sparkles_1", this.posX, this.posY + 2, this.posZ);
			if (effect != null){
	...
	protected boolean canDespawn(){
		return ArsMagicaReborn.config.canDraydsDespawn();
	}
