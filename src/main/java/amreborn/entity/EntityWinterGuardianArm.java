...
public class EntityWinterGuardianArm extends EntityLiving{
	...
	public void onUpdate(){
		...
		if (isInWater()){
			...
			for (int i = 0; i < 2; ++i){
				AMParticle particle = (AMParticle)ArsMagicaReborn.proxy.particleManager.spawn(world, "ember", posX + rand.nextFloat() * 0.2 - 0.1, posY + 1.2, posZ + rand.nextFloat() * 0.2 - 0.1);
				if (particle != null){
