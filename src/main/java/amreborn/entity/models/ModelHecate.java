package amreborn.entity.models;

import java.util.Calendar;

import amreborn.ArsMagicaReborn;
import amreborn.entity.EntityHecate;
import amreborn.models.ModelSantaHat;
...
public class ModelHecate extends ModelBase{
	...
	private static final ResourceLocation hatLoc = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/SantaHat.png");
