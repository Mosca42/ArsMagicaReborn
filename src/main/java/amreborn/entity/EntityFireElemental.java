...
import amreborn.entity.ai.EntityAIFireballAttack;
import amreborn.particles.AMParticle;
import amreborn.particles.ParticleApproachPoint;
	...
	public void onUpdate(){
		...
		if (cookTargetID != 0){
			...
			if (inanimate != null && world.isRemote){
				AMParticle effect = (AMParticle)ArsMagicaReborn.proxy.particleManager.spawn(world, "fire", posX, posY + getEyeHeight(), posZ);
				if (effect != null){
