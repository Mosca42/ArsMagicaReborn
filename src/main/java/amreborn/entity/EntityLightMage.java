...
import amreborn.entity.ai.EntityAIAllyManaLink;
import amreborn.entity.ai.EntityAIRangedAttackSpell;
import amreborn.entity.ai.selectors.LightMageEntitySelector;
...
//	
	...
	public EnumActionResult applyPlayerInteraction(EntityPlayer player, Vec3d vec, EnumHand hand){
		...
		if (player.getHeldItem(hand) != ItemStack.EMPTY && player.getHeldItem(hand).getItem() instanceof ItemNameTag)
			return EnumActionResult.PASS;
	...
	public String getTexture(){
		return String.format(ArsMagicaReborn.MODID + ":textures/mobs/light_mages/light_mage_%d.png", this.dataManager.get(MAGE_SKIN).intValue());
	}
}
