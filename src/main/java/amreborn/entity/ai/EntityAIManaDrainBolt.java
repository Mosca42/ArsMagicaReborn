...
public class EntityAIManaDrainBolt extends EntityAIBase{
	...
	private void doRangedAttack(){
		...
		if (worldObj.rand.nextInt(100) < chanceToMiss){
			ArsMagicaReborn.proxy.particleManager.BoltFromPointToPoint(worldObj,
			...
			ArsMagicaReborn.proxy.particleManager.BoltFromEntityToEntity(worldObj, entityHost, entityHost, attackTarget, this.damage, 2, -1);
