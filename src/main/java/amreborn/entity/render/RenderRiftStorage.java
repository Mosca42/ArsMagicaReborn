...
public class RenderRiftStorage extends Render<EntityRiftStorage> {
	...
	private static final ResourceLocation TEXTURE_MAIN = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/Rift.png");
	private static final ResourceLocation TEXTURE_SECONDARY = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/Rift2.png");
