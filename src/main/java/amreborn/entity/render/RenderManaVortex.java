...
public class RenderManaVortex extends Render<EntityManaVortex>{
	...
	private static final ResourceLocation vortex = new ResourceLocation(ArsMagicaReborn.MODID, "textures/blocks/custom/Magic_Fabricator_2.png");
	private static final ResourceLocation wisp = new ResourceLocation(ArsMagicaReborn.MODID, "textures/mobs/mob_wisp.png");
