...
import amreborn.bosses.ai.EntityAIEnderRush;
import amreborn.bosses.ai.EntityAIEnderbolt;
import amreborn.bosses.ai.EntityAIEndertorrent;
import amreborn.bosses.ai.EntityAIEnderwave;
import amreborn.bosses.ai.EntityAIOtherworldlyRoar;
import amreborn.bosses.ai.EntityAIProtect;
import amreborn.bosses.ai.EntityAIShadowstep;
		...
		if (par1DamageSource.damageType.equals("outOfWorld")){
			if (spawn != null){
				...
				if (!this.world.isRemote)
					ArsMagicaReborn.proxy.addDeferredTargetSet(this, null);
			}else{
				this.setDead();
			}
			return false;
