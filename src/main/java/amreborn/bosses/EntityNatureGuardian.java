...
import amreborn.bosses.ai.EntityAIPlantGuardianThrowSickle;
import amreborn.bosses.ai.EntityAIShieldBash;
import amreborn.bosses.ai.EntityAISpinAttack;
...
public class EntityNatureGuardian extends AM2Boss{
	...
	private void spawnParticles(){
		AMParticle leaf = (AMParticle)ArsMagicaReborn.proxy.particleManager.spawn(world, "leaf", posX + (rand.nextDouble() * 3) - 1.5f, posY + (rand.nextDouble() * 5f), posZ + (rand.nextDouble() * 3) - 1.5f);
		if (leaf != null){
			leaf.setMaxAge(20);
