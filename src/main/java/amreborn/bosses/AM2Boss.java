...
public abstract class AM2Boss extends EntityMob implements IEntityMultiPart, IArsMagicaBoss{
	...
	public void onUpdate(){
		...
		if (world.isRemote){
			playerCanSee = ArsMagicaReborn.proxy.getLocalPlayer().canEntityBeSeen(this);
			this.ignoreFrustumCheck = ArsMagicaReborn.proxy.getLocalPlayer().getDistanceToEntity(this) < 32;
		}
