...
public class ParticleLeaveParticleTrail extends ParticleController{
	...
	public void doUpdate(){
		...
		if (updateTicks == ticksBetweenSpawns){
			updateTicks = 0;
			AMParticle effect = (AMParticle)ArsMagicaReborn.proxy.particleManager.spawn(particle.getWorldObj(), particleName, particle.getPosX(), particle.getPosY(), particle.getPosZ());
			if (effect != null){
