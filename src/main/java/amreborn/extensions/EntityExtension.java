...
import static amreborn.extensions.DataDefinitions.AFFINITY_HEAL_COOLDOWN;
import static amreborn.extensions.DataDefinitions.CONTENGENCY_STACK;
import static amreborn.extensions.DataDefinitions.CONTENGENCY_TYPE;
import static amreborn.extensions.DataDefinitions.CURRENT_LEVEL;
import static amreborn.extensions.DataDefinitions.CURRENT_MANA;
import static amreborn.extensions.DataDefinitions.CURRENT_MANA_FATIGUE;
import static amreborn.extensions.DataDefinitions.CURRENT_SUMMONS;
import static amreborn.extensions.DataDefinitions.CURRENT_XP;
import static amreborn.extensions.DataDefinitions.FALL_PROTECTION;
import static amreborn.extensions.DataDefinitions.FLIP_ROTATION;
import static amreborn.extensions.DataDefinitions.HEAL_COOLDOWN;
import static amreborn.extensions.DataDefinitions.IS_INVERTED;
import static amreborn.extensions.DataDefinitions.IS_SHRUNK;
import static amreborn.extensions.DataDefinitions.MANA_SHIELD;
import static amreborn.extensions.DataDefinitions.MARK_DIMENSION;
import static amreborn.extensions.DataDefinitions.MARK_X;
import static amreborn.extensions.DataDefinitions.MARK_Y;
import static amreborn.extensions.DataDefinitions.MARK_Z;
import static amreborn.extensions.DataDefinitions.PREV_FLIP_ROTATION;
import static amreborn.extensions.DataDefinitions.PREV_SHRINK_PCT;
import static amreborn.extensions.DataDefinitions.SHRINK_PCT;
import static amreborn.extensions.DataDefinitions.TK_DISTANCE;
...
import amreborn.api.event.PlayerMagicLevelChangeEvent;
...
public class EntityExtension implements IEntityExtension, ICapabilityProvider, ICapabilitySerializable<NBTBase> {
	...
	public static final ResourceLocation ID = new ResourceLocation(ArsMagicaReborn.MODID + ":ExtendedProp");
		...
		if (entity.world != null && entity.world.isRemote){
			for (ManaLinkEntry entry : this.manaLinks){
				...
				if (e != null && e.getDistanceSqToEntity(entity) < entry.range && e.ticksExisted % 90 == 0){
					AMLineArc arc = (AMLineArc)ArsMagicaReborn.proxy.particleManager.spawn(entity.world, "textures/blocks/oreblockbluetopaz.png", e, entity);
					if (arc != null){
