...
public class AMEnchantments{
	...
	public static void Init(){
		GameRegistry.register(magicResist, new ResourceLocation(ArsMagicaReborn.MODID, "magicResist"));
		GameRegistry.register(soulbound, new ResourceLocation(ArsMagicaReborn.MODID, "soulbound"));
	}
