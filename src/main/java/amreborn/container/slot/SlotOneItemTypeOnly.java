...
public class SlotOneItemTypeOnly extends Slot{
	...
	public boolean isItemValid(ItemStack par1ItemStack){
		if (meta == -1)
			return par1ItemStack != ItemStack.EMPTY && par1ItemStack.getItem() != null && par1ItemStack.getItem() == this.item;
		return par1ItemStack != ItemStack.EMPTY && par1ItemStack.getItem() != null && par1ItemStack.getItem() == this.item && par1ItemStack.getItemDamage() == meta;
	}
