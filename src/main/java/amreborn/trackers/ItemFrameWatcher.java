...
public class ItemFrameWatcher{
	...
	public void spawnCompendiumProgressParticles(EntityItemFrame frame, BlockPos pos){
		...
		AMParticle particle = (AMParticle)ArsMagicaReborn.proxy.particleManager.spawn(frame.world, "symbols", pos.getX() + rand.nextDouble(), pos.getY() + rand.nextDouble(), pos.getZ() + rand.nextDouble());
		if (particle != null){
	...
	public void spawnCompendiumCompleteParticles(EntityItemFrame frame){
		AMParticle particle = (AMParticle)ArsMagicaReborn.proxy.particleManager.spawn(frame.world, "radiant", frame.posX, frame.posY, frame.posZ);
		if (particle != null){
