...
import amreborn.utils.WebRequestUtils;
...
public class PlayerTracker{
	...
	public void onPlayerLogin(PlayerLoggedInEvent event){
		...
		int[] disabledSkills = ArsMagicaReborn.disabledSkills.getDisabledSkillIDs();

		AMDataWriter writer = new AMDataWriter();
		writer.add(ArsMagicaReborn.config.getSkillTreeSecondaryTierCap()).add(disabledSkills);
		writer.add(ArsMagicaReborn.config.getManaCap());
