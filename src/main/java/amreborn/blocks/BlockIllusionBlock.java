...
import amreborn.items.ItemBlockIllusion;
...
public class BlockIllusionBlock extends BlockAMContainer {
	...
	public Object[] GetRecipeComponents(boolean alwaysPassable) {
		if (alwaysPassable) {
			return new Object[] { "BRB", "RGR", "BRB", Character.valueOf('R'), new ItemStack(ItemDefs.rune, 1, EnumDyeColor.BLACK.getDyeDamage()), Character.valueOf('G'), Blocks.GLASS, Character.valueOf('B'), new ItemStack(ItemDefs.itemOre, 1, ItemOre.META_CHIMERITE) };
		} else {
			return new Object[] { "BRB", "R R", "BRB", Character.valueOf('R'), new ItemStack(ItemDefs.rune, 1, EnumDyeColor.BLACK.getDyeDamage()), Character.valueOf('B'), new ItemStack(ItemDefs.itemOre, 1, ItemOre.META_CHIMERITE) };
		}
	}
