...
import amreborn.models.ModelEssenceConduit;
...
public class TileEssenceConduitRenderer extends TileEntitySpecialRenderer<TileEntityEssenceConduit>{
	...
	public TileEssenceConduitRenderer(){
		...
		powered = new ResourceLocation(ArsMagicaReborn.MODID, "textures/blocks/custom/essenceconduit.png");
		//unPowered = new ResourceLocation(ArsMagicaReborn.MODID, "textures/blocks/custom/essenceConduitUnpowered.png");
	}
	
	private void createModel() {
		try {
			modelCrystal = ModelLoaderRegistry.getModel(new ResourceLocation(ArsMagicaReborn.MODID, "block/crystal.obj"));
		} catch (Exception e) {
