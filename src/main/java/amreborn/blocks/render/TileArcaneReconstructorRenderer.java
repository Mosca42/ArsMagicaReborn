...
import amreborn.bosses.renderers.RenderItemNoBob;
...
public class TileArcaneReconstructorRenderer extends TileEntitySpecialRenderer<TileEntityArcaneReconstructor> {
	...
	private void bake() {
		try {
			mainModel = ModelLoaderRegistry.getModel(new ResourceLocation(ArsMagicaReborn.MODID, "block/reconstructor/main.obj"));
			ring1Model = ModelLoaderRegistry.getModel(new ResourceLocation(ArsMagicaReborn.MODID, "block/reconstructor/ring1.obj"));
			ring2Model = ModelLoaderRegistry.getModel(new ResourceLocation(ArsMagicaReborn.MODID, "block/reconstructor/ring2.obj"));
			ring3Model = ModelLoaderRegistry.getModel(new ResourceLocation(ArsMagicaReborn.MODID, "block/reconstructor/ring3.obj"));
		} catch (Exception e) {
