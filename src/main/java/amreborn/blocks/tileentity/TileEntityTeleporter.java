...
public class TileEntityTeleporter extends TileEntity implements ITickable {
	...
	public void onLoad() {
		...
		default:
			...
			.add(0, -1, 0, Blocks.DIAMOND_BLOCK)
			.add(0, 1, 0, Blocks.AIR)
			.add(0, -2, 0, Blocks.STONEBRICK)
			.add(0, -2, 1, Blocks.STONEBRICK)
			.add(0, -2, -1, Blocks.STONEBRICK)
			.add(1, -2, 1, Blocks.STONEBRICK)
			.add(-1, -2, -1, Blocks.STONEBRICK)
			.add(-1, -2, 1, Blocks.STONEBRICK)
			.add(1, -2, 0, Blocks.STONEBRICK)
			.add(-1, -2, 0, Blocks.STONEBRICK)
			.add(1, -2, -1, Blocks.STONEBRICK)
			
			.add(-1, -1, 1, Blocks.GLASS)
			.add(1, -1, -1, Blocks.GLASS)
			.add(-1, -1, -1, Blocks.GLASS)
			.add(1, -1, 1, Blocks.GLASS)
			
			.add(0, -1, 1, Blocks.STONE_BRICK_STAIRS)
			.add(0, -1, 1, Blocks.STONE_BRICK_STAIRS)
			.add(-1, -1, 0, Blocks.STONE_BRICK_STAIRS)
			.add(1, -1, 0, Blocks.STONE_BRICK_STAIRS);
		}
	}
