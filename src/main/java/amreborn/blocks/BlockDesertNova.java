...
public class BlockDesertNova extends BlockAMFlower{
	...
	public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random par5Random){
		...
		int increment = ArsMagicaReborn.config.getGFXLevel() * 15;
		...
		for (int i = 0; i < 360; i += increment){
			...
			AMParticle effect = (AMParticle)ArsMagicaReborn.proxy.particleManager.spawn(world, "explosion_2", pos.getX() + 0.5, posY, pos.getZ() + 0.5);
			if (effect != null){
